...
locals {
  // locals for 'os_version' allowed values
...
locals {
  // locals for 'installation_type' allowed values
...
locals {
  // locals for  'vm_size' allowed values
  allowed_vm_sizes = [
    "Standard_DS2_v2",
    "Standard_DS3_v2",
    "Standard_DS4_v2",
...
locals {
  // locals for 'vm_os_offer' allowed values
...
locals {
  // locals for 'vm_os_sku' allowed values
...
locals {
  // locals for 'storage_account_type' allowed values
...
locals {
  // locals for 'storage_account_tier' allowed values
...
locals {
  // locals for 'account_replication_type' allowed values
...
locals {
  // local for 'disk_size' allowed regex
...
locals {
  // locals for 'managed_disk_type' allowed values
